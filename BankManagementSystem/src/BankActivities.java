...
//
//    private final Scanner scanner;
//    private User currentUser;          // CHANGED — operates on the logged-in user, not a free Balance object
//    double amount;
//    int response;
//    File file = new File("Info.ser");  // same file Account uses
//
...
//            saveUpdatedUser();              // NEW — persist immediately
//        }
//    }
//
//    public void deposit(){
...
//            return;                          // CHANGED — was an infinite loop with no re-prompt before
//        }
//
//        currentUser.setBalance(currentUser.getBalance() + amount);
//        System.out.println("You have successfully deposited " + amount);
...
//                users.set(i, currentUser);   // overwrite with updated balance
//                found = true;
//                break;
//            }
//        }
//        if(!found){
//            users.add(currentUser);          // safety net, shouldn't normally happen
//        }
//
